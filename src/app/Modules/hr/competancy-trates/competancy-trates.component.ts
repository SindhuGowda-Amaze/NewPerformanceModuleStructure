...
@Component({
  selector: 'app-competancy-trates',
  templateUrl: './competancy-trates.component.html',
  styleUrls: ['./competancy-trates.component.css']
})
export class CompetancyTratesComponent implements OnInit {
