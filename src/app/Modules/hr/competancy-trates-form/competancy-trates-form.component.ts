...
@Component({
  selector: 'app-competancy-trates-form',
  templateUrl: './competancy-trates-form.component.html',
  styleUrls: ['./competancy-trates-form.component.css']
})
export class CompetancyTratesFormComponent implements OnInit {
  ...
  save() {
    ...
    location.href = "#/hr/CompetancyTrates";
  }
