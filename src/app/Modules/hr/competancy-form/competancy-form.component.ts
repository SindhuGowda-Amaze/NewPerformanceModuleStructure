...
@Component({
  selector: 'app-competancy-form',
  templateUrl: './competancy-form.component.html',
  styleUrls: ['./competancy-form.component.css']
})
export class CompetancyFormComponent implements OnInit {
  ...
  save() {
    ...
    location.href = "#/hr/Competancydash";
  }
