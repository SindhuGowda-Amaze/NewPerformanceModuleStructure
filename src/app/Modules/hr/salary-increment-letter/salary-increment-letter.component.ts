...
@Component({
  selector: 'app-salary-increment-letter',
  templateUrl: './salary-increment-letter.component.html',
  styleUrls: ['./salary-increment-letter.component.css']
})
export class SalaryIncrementLetterComponent implements OnInit {
