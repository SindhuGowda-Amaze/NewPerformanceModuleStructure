...
@Component({
  selector: 'app-emp-competancy-appraisal',
  templateUrl: './emp-competancy-appraisal.component.html',
  styleUrls: ['./emp-competancy-appraisal.component.css']
})
export class EmpCompetancyAppraisalComponent implements OnInit {
