...
@Component({
  selector: 'app-emp-competancy-rating-page',
  templateUrl: './emp-competancy-rating-page.component.html',
  styleUrls: ['./emp-competancy-rating-page.component.css']
})
export class EmpCompetancyRatingPageComponent implements OnInit {
