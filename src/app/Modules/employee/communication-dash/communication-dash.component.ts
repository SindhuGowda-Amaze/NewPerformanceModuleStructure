...
@Component({
  selector: 'app-communication-dash',
  templateUrl: './communication-dash.component.html',
  styleUrls: ['./communication-dash.component.css']
})
export class CommunicationDashComponent implements OnInit {
