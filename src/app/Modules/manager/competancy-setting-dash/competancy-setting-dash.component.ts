...
@Component({
  selector: 'app-competancy-setting-dash',
  templateUrl: './competancy-setting-dash.component.html',
  styleUrls: ['./competancy-setting-dash.component.css']
})
export class CompetancySettingDashComponent implements OnInit {
