...
@Component({
  selector: 'app-competancy-setting',
  templateUrl: './competancy-setting.component.html',
  styleUrls: ['./competancy-setting.component.css']
})
export class CompetancySettingComponent implements OnInit {
