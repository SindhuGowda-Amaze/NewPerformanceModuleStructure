...
@Component({
  selector: 'app-manager-competancy-appraisal',
  templateUrl: './manager-competancy-appraisal.component.html',
  styleUrls: ['./manager-competancy-appraisal.component.css']
})
export class ManagerCompetancyAppraisalComponent implements OnInit {
