...
@Component({
  selector: 'app-manager-competancy-rating-page',
  templateUrl: './manager-competancy-rating-page.component.html',
  styleUrls: ['./manager-competancy-rating-page.component.css']
})
export class ManagerCompetancyRatingPageComponent implements OnInit {
